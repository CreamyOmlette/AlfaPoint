    ...
    <div className="service-descriptor">
      ...
      <div className="service-content">
        ...
        >
          ...
          >
            {activeService && activeService.id === "0" && (
              <video
                ...
                preload="yes"
                playsInline
                poster={storage[0].poster}
              >
                <source src={storage[0].video} type="video/mp4" />
              </video>
            )}
            {activeService && activeService.id === "1" && (
              <video
                ...
                preload="yes"
                playsInline
                poster={storage[1].poster}
              >
                <source src={storage[1].video} type="video/mp4" />
              </video>
            )}
            {activeService && activeService.id === "2" && (
              <video
                className="service-content-video-bg"
                autoPlay
                muted
                ...
                preload="yes"
                playsInline
                poster={storage[2].poster}
              >
                <source src={storage[2].video} type="video/mp4" />
              </video>
            )}
            {activeService && activeService.id === "3" && (
              <video
                className="service-content-video-bg"
                autoPlay
                muted
                ...
                preload="yes"
                playsInline
                poster={storage[3].poster}
              >
                <source src={storage[3].video} type="video/mp4" />
              </video>
            )}
